    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          rebateRate: 'First Payment Rebate Rate',
          rebateRateHint: 'Rate used for an invitee’s first eligible payment or balance recharge (0-100%).',
          repeatRebateRate: 'Repeat Purchase Rebate Rate',
          repeatRebateRateHint: 'Rate used for every eligible purchase or recharge after the first rebate (0-100%).',
          ...
          customUsers: {
            ...
            description: 'Set a custom invite code or one exclusive rate that overrides both first-payment and repeat-purchase rates. Lists only users with overrides.',
          ...
          modal: {
            ...
            rateLabel: 'Exclusive Unified Rebate Rate (optional)',
            ratePlaceholder: 'e.g. 30',
            rateHint: '0-100; applies to both payment stages. Leave empty in edit mode to use the two global rates.',
