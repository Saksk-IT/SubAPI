export default {
  ...
  payment: {
    ...
    purchaseGuide: {
      ...
      contactTitle: 'Confirm details before or after purchase',
      contactSubtitle: 'Administrators can show a support QR code, contact details, and purchase notes here for plan choice, payment, fulfillment timing, or invoice questions.',
    ...
    admin: {
      ...
      purchaseSupportConfig: 'Purchase Page Support',
      purchaseSupportConfigDesc: 'Configure the support details shown on the user top-up/subscription page.',
      supportContactInfo: 'Support contact',
      supportContactInfoPlaceholder: 'Example: WeChat: subapi-support\nQQ: 123456789\nEmail: support@example.com',
      supportHelpImageUrl: 'QR image URL',
      supportHelpImageUrlPlaceholder: 'https://example.com/support-qr.png',
      supportHelpText: 'Purchase notes',
      supportHelpTextPlaceholder: 'Example: Contact support before payment to confirm the plan, fulfillment rules, or invoice details.',
      saveSupportConfig: 'Save support config',
      supportConfigSaved: 'Purchase page support config saved',
      supportConfigLoadFailed: 'Failed to load purchase page support config',
      supportConfigSaveFailed: 'Failed to save purchase page support config',
