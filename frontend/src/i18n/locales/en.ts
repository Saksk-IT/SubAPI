export default {
  ...
  payment: {
    ...
    purchaseGuide: {
      eyebrow: 'API Top-Up',
      title: 'Choose how you want to use the API',
      subtitle: 'This page presents balance products and subscription plans for API customers. Benefits are applied automatically after purchase.',
      apiRechargeTitle: 'Customer-facing API products',
      apiRechargeDescription: 'Top-up products are for on-demand API calls. After purchase, balance or credits are added to the account and consumed by later requests.',
      rechargeTitle: 'Top-up mode',
      rechargeDescription: 'Add balance first, then deduct by model, multiplier, or actual request usage. Best for variable usage and flexible cost control.',
      subscriptionTitle: 'Subscription mode',
      subscriptionDescription: 'Buy a time-based plan that grants group access, quota, or validity benefits. Best for steady recurring usage and predictable quota.',
      billingTitle: 'Billing differences',
      billingRecharge: 'Top-up: actual API usage deducts from balance, and unused balance stays on the account.',
      billingSubscription: 'Subscription: billed by plan validity, with included quota, multiplier, or access during the cycle.',
      contactEyebrow: 'Support',
      contactTitle: 'Contact support before or after purchase',
      contactSubtitle: 'QR code, notes, and contact details are customized by administrators. Use this for WeChat, QQ, email, or ticket links.',
