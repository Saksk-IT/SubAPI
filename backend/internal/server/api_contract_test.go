...
func (stubGroupRepo) UpdateRateMultipliers(ctx context.Context, updates []service.GroupRateMultiplierUpdate) error {
	return nil
}
...
func (r *stubUsageLogRepo) GetDailyMetrics(ctx context.Context, startTime, endTime time.Time) (*usagestats.DailyMetricsResponse, error) {
	return nil, errors.New("not implemented")
}
