...
func TestRedactAuditBody_JSONRedactsSecrets(t *testing.T) {
	raw := []byte(`{
		...
		"totp_code": "123456",
		"verify_code": "verify-654321",
		"promo_code": "promo-private",
		"invitation_code": "invite-private",
		"aff_code": "affiliate-private",
	...
	for _, secret := range []string{
		"sk-secret-123", "hunter2", "123456", "verify-654321", "promo-private",
		"invite-private", "affiliate-private", "tok_abc",
	} {
