  ...
  admin: {
    ...
    users: {
      ...
      batchAssign: {
        ...
        allUsersHint:
          'This operation targets every user in the system. Balance deductions that would make a user negative are skipped and reported.',
        actionType: 'Action',
        ...
        validityDaysHint:
          'If the user already has this subscription, the days are added to the existing expiration.',
    ...
    subscriptions: {
      ...
      bulkAdjustHint:
        'Apply the same day adjustment to selected subscriptions. Expired subscriptions or subscriptions with insufficient remaining time may fail.',
