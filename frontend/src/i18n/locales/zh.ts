export default {
  ...
  payment: {
    ...
    purchaseGuide: {
      ...
      contactEyebrow: '客服支持',
      contactTitle: '购买前后都可以确认',
      contactSubtitle: '这里展示管理员配置的客服二维码、联系方式和购买说明，可用于确认套餐选择、付款方式、到账时间或发票等问题。',
      contactQr: '扫码联系客服',
      contactInfo: '联系方式',
      helpTitle: '购买说明',
    ...
    admin: {
      ...
      months: '月',
      searchOrders: '搜索订单...',
      purchaseSupportConfig: '购买页客服配置',
      purchaseSupportConfigDesc: '配置用户充值/订阅页右侧展示的客服信息。',
      supportContactInfo: '客服联系方式',
      supportContactInfoPlaceholder: '例如：微信：subapi-support\nQQ：123456789\n邮箱：support@example.com',
      supportHelpImageUrl: '二维码图片链接',
      supportHelpImageUrlPlaceholder: 'https://example.com/support-qr.png',
      supportHelpText: '购买说明',
      supportHelpTextPlaceholder: '例如：付款前可先联系客服确认套餐、到账规则和发票信息。',
      saveSupportConfig: '保存客服配置',
      supportConfigSaved: '购买页客服配置已保存',
      supportConfigLoadFailed: '加载购买页客服配置失败',
      supportConfigSaveFailed: '保存购买页客服配置失败',
      allStatuses: '全部状态',
