...
describe('buildApiUrl', () => {
  it('keeps the managed same-origin /v1 base relative', () => {
    expect(buildApiUrl('/v1', 'images/generations', null, false)).toBe('/v1/images/generations')
    expect(buildApiUrl('/v1', 'responses', null, false)).toBe('/v1/responses')
  })
