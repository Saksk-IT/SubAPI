...
const (
	...
	AffiliateRepeatRebateRateDefault    = AffiliateRebateRateDefault
...
const (
	...
	SettingKeyAffiliateRebateRate              = "affiliate_rebate_rate"               // 首次付费返利比例（百分比，0-100；保留旧 key 兼容）
	SettingKeyAffiliateRepeatRebateRate        = "affiliate_repeat_rebate_rate"        // 持续复购返利比例（百分比，0-100）
