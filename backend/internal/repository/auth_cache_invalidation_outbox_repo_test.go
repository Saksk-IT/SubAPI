...
func TestAuthCacheInvalidationMigration_SecurityCoverageAndNoPlaintextPayload(t *testing.T) {
	...
	for _, required := range []string{
		...
		"OLD.allow_image_generation", "OLD.allow_batch_image_generation", "OLD.allow_messages_dispatch",
		"OLD.supported_model_scopes", "OLD.model_routing", "OLD.claude_code_only",
