...
import {
  ...
  useAppStore,
  useAuthStore,
  useImageGenerationLauncherStore,
  useOnboardingStore,
} from '@/stores'
...
const imageGenerationLauncherStore = useImageGenerationLauncherStore()
    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'm2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5A1.5 1.5 0 0 0 21.75 18V6A1.5 1.5 0 0 0 20.25 4.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm4.875-5.25v3.375m1.688-1.688h-3.375'
        })
      ]
    )
}
    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.847a4.5 4.5 0 003.09 3.09L15.75 12l-2.847.813a4.5 4.5 0 00-3.09 3.091zM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 00-2.456-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.894 20.567 16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394-1.183.394a2.25 2.25 0 00-1.423 1.423z'
        })
      ]
    )
}
...
const flagImageGenerationEntry = () =>
  flagImageGeneration() && canUseImageGeneration.value
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    { path: '/keys', label: t('nav.apiKeys'), icon: KeyIcon },
    {
      ...
      action: 'image-generation',
      featureFlag: flagImageGenerationEntry,
    },
    ...
    { path: '/activities', label: t('nav.activities'), icon: ActivityIcon },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/data-dashboard', label: t('nav.dataDashboard'), icon: ChartIcon },
    ...
    { path: '/admin/groups', label: t('nav.groups'), icon: FolderIcon, hideInSimpleMode: true },
    {
      ...
      children: [
        ...
        { path: '/admin/channels/status', label: t('nav.channelStatus'), icon: SignalIcon, featureFlag: flagChannelMonitor },
...
function handleMenuItemClick(item: NavItem, event?: MouseEvent) {
  if (item.action === 'image-generation') {
    event?.preventDefault()
    imageGenerationLauncherStore.open()
  }
 ...
 * - When sidebar is collapsed: expand it and reveal this group's children.
