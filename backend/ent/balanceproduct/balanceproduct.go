...
const (
	// Label holds the string label denoting the balanceproduct type in the database.
	Label = "balance_product"
	...
	// Table holds the table name of the balanceproduct in the database.
	Table = "balance_products"
)

// Columns holds all SQL columns for balanceproduct fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldDescription,
...
// OrderOption defines the ordering options for the BalanceProduct queries.
