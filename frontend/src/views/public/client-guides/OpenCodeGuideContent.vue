...
<template>
  ...
  <ol class="codex-steps-list">
    ...
    <li>首次启动后退出 Open Code，再写入配置文件；这样可以避免配置目录不存在。</li>
  </ol>
  ...
  <div class="codex-doc-table-wrap">
    <table class="codex-doc-table">
      ...
      <tbody>
        <tr><td><strong>Windows</strong></td><td><code>%USERPROFILE%\.config\opencode\</code></td><td><code>opencode.json</code> 或 <code>opencode.jsonc</code></td></tr>
        <tr><td><strong>macOS</strong></td><td><code>~/.config/opencode/</code></td><td><code>opencode.json</code> 或 <code>opencode.jsonc</code></td></tr>
        <tr><td><strong>Linux</strong></td><td><code>~/.config/opencode/</code></td><td><code>opencode.json</code> 或 <code>opencode.jsonc</code></td></tr>
      </tbody>
    </table>
  </div>
  <section class="codex-callout">
  ...
  <ul class="codex-steps-list">
    <li><code>provider</code> 下的 <code>sakms</code> 是自定义名称，后续在 Open Code 内选择对应 provider 即可。</li>
    <li><code>baseURL</code> 对大小写敏感，Open Code 示例中使用的是 <code>baseURL</code>，不要写成 <code>base_url</code>。</li>
