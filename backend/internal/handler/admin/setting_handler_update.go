...
type UpdateSettingsRequest struct {
	...
	SessionBindingEnabled            *bool                        `json:"session_binding_enabled"`  // 会话 IP/UA 绑定；nil 保留旧值
	AuditLogRetentionDays            *int                         `json:"audit_log_retention_days"` // 审计日志保留天数；nil 保留旧值
	...
	AffiliateRepeatRebateRate                 *float64                          `json:"affiliate_repeat_rebate_rate"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	affiliateRepeatRebateRate := previousSettings.AffiliateRepeatRebateRate
	if req.AffiliateRepeatRebateRate != nil {
		affiliateRepeatRebateRate = *req.AffiliateRepeatRebateRate
	}
	if affiliateRepeatRebateRate < service.AffiliateRebateRateMin {
		affiliateRepeatRebateRate = service.AffiliateRebateRateMin
	}
	if affiliateRepeatRebateRate > service.AffiliateRebateRateMax {
		affiliateRepeatRebateRate = service.AffiliateRebateRateMax
	}
	...
	redeemCodeRebateEnabled := previousSettings.RedeemCodeRebateEnabled
	if req.RedeemCodeRebateEnabled != nil {
		redeemCodeRebateEnabled = *req.RedeemCodeRebateEnabled
	}
	...
	settings := &service.SystemSettings{
		...
		SessionBindingEnabled:            resolveSessionBindingEnabled(req.SessionBindingEnabled, previousSettings.SessionBindingEnabled),
		AuditLogRetentionDays:            resolveAuditLogRetentionDays(req.AuditLogRetentionDays, previousSettings.AuditLogRetentionDays),
		...
		AffiliateRepeatRebateRate:              affiliateRepeatRebateRate,
		AffiliateRebateFreezeHours:             affiliateRebateFreezeHours,
		AffiliateRebateDurationDays:            affiliateRebateDurationDays,
		AffiliateRebatePerInviteeCap:           affiliateRebatePerInviteeCap,
		AdminRechargeRebateEnabled:             adminRechargeRebateEnabled,
		RedeemCodeRebateEnabled:                redeemCodeRebateEnabled,
	...
	payload := dto.SystemSettings{
		...
		AffiliateRepeatRebateRate:                              updatedSettings.AffiliateRepeatRebateRate,
		AffiliateRebateFreezeHours:                             updatedSettings.AffiliateRebateFreezeHours,
		AffiliateRebateDurationDays:                            updatedSettings.AffiliateRebateDurationDays,
		AffiliateRebatePerInviteeCap:                           updatedSettings.AffiliateRebatePerInviteeCap,
		AdminRechargeRebateEnabled:                             updatedSettings.AdminRechargeRebateEnabled,
		RedeemCodeRebateEnabled:                                updatedSettings.RedeemCodeRebateEnabled,
...
func resolveSessionBindingEnabled(value *bool, previous bool) bool {
	if value == nil {
		return previous
	}
	return *value
...
func resolveAuditLogRetentionDays(value *int, previous int) int {
	if value == nil {
		return previous
	}
	return *value
