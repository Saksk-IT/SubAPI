...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	groupRateScheduleService := service.ProvideGroupRateScheduleService(settingRepository, groupRepository, apiKeyAuthCacheInvalidator)
	...
	dailyCheckInActivityService := service.NewDailyCheckInActivityService(dailyCheckInRepository, billingCache, apiKeyAuthCacheInvalidator)
	activityHandler := admin.NewActivityHandler(firstRechargeActivityService, dailyCheckInActivityService, adminService)
	...
	openAIImageJobRepository := repository.NewOpenAIImageJobRepository(db)
	openAIImageJobExecutor := handler.NewOpenAIImageJobExecutor(openAIGatewayHandler, apiKeyService, subscriptionService, settingService, opsService, configConfig)
	openAIImageJobWorkerRuntime := service.ProvideOpenAIImageJobWorkerRuntime(openAIImageJobRepository, openAIImageJobExecutor, configConfig)
	openAIImageJobHandler := handler.ProvideOpenAIImageJobHandler(openAIImageJobRepository, openAIGatewayService, configConfig, openAIImageJobWorkerRuntime, openAIGatewayHandler)
	...
	userActivityService := service.NewUserActivityService(firstRechargeActivityService, dailyCheckInActivityService)
	handlerActivityHandler := handler.NewActivityHandler(userActivityService, firstRechargeActivityService, dailyCheckInActivityService)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, groupRateScheduleService, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, openAIImageJobWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, auditLogService, promptService)
	application := &Application{
		Server:               httpServer,
		PromptAudit:          promptService,
		OpenAIImageJobWorker: openAIImageJobWorkerRuntime,
		Cleanup:              v,
	}
