...
var (
	...
	ErrReleaseBuildRequired      = infraerrors.Conflict("RELEASE_BUILD_REQUIRED", "remote update and rollback are only available for release builds")
)
...
func (s *UpdateService) ListRollbackVersions(ctx context.Context) ([]RollbackVersion, error) {
	if s.buildType != "release" {
		return nil, ErrReleaseBuildRequired
	}
