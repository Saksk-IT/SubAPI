...
type wechatPaymentOAuthContext struct {
	...
	BalanceProductID     int64  `json:"balance_product_id,omitempty"`
	FirstRechargeOfferID int64  `json:"first_recharge_offer_id,omitempty"`
}
...
func (h *AuthHandler) WeChatPaymentOAuthStart(c *gin.Context) {
	...
	rawContext, err := encodeWeChatPaymentOAuthContext(wechatPaymentOAuthContext{
		...
		BalanceProductID:     parseWeChatPaymentPlanID(c.Query("balance_product_id")),
		FirstRechargeOfferID: parseWeChatPaymentPlanID(c.Query("first_recharge_offer_id")),
	})
	if err != nil {
...
func (h *AuthHandler) WeChatPaymentOAuthCallback(c *gin.Context) {
	...
	resumeToken, err := h.wechatPaymentResumeService().CreateWeChatPaymentResumeToken(service.WeChatPaymentResumeClaims{
		...
		BalanceProductID:     paymentContext.BalanceProductID,
		FirstRechargeOfferID: paymentContext.FirstRechargeOfferID,
