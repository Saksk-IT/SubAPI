...
func ProvideOpenAIImageJobHandler(
	...
	h := NewOpenAIImageJobHandler(repository, gatewayService, cfg, cancelNotifier)
	h.openAI = openAI
	return h
}
...
func ProvideHandlers(
	...
	openaiImageJobHandler *OpenAIImageJobHandler,
	...
	return &Handlers{
		...
		OpenAIImageJob:   openaiImageJobHandler,
		Setting:          settingHandler,
		Totp:             totpHandler,
		Payment:          paymentHandler,
