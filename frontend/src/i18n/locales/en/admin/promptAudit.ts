export default {
  promptAudit: {
    ...
    events: {
      ...
      filterDeleteDialogTitle: 'Delete audit events by filter', filterDeleteDialogDesc: 'Choose the time range and risk criteria, generate a preview, review the match count, and then confirm permanent deletion.',
      ...
      filterDeletePreviewAction: 'Generate delete preview', filterDeletePreviewing: 'Generating preview…', filterDeleteNeedPreview: 'Generate a delete preview and review the match count first.',
