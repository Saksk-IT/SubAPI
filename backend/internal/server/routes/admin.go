...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/daily-metrics", h.Admin.Dashboard.GetDailyMetrics)
...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/batch-assign", h.Admin.User.BatchAssign)
...
func registerGroupRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	groups := admin.Group("/groups")
	{
		...
		groups.GET("/rate-schedule", h.Admin.Group.GetRateSchedule)
		groups.PUT("/rate-schedule", h.Admin.Group.UpdateRateSchedule)
...
func registerRedeemCodeRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	codes := admin.Group("/redeem-codes")
	{
		...
		codes.POST("", h.Admin.Redeem.Create)
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.POST("/bulk-adjust", h.Admin.Subscription.BulkAdjust)
