...
func (h *OpenAIGatewayHandler) handleGrokMedia(c *gin.Context, endpoint service.GrokMediaEndpoint, requestID string) {
	...
	// Video lookups retrieve work accepted and billed earlier. Keep authentication,
	// ownership binding, concurrency, and upstream forwarding, but do not require
	// the key to remain eligible to create another billed request.
