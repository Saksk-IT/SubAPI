...
var (
	...
	ChannelMonitorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorsColumns[13], ChannelMonitorsColumns[0]},
			},
			{
				Name:    "channelmonitor_enabled_sort_order_id",
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorsColumns[11], ChannelMonitorsColumns[13], ChannelMonitorsColumns[0]},
			},
			{
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "activity_type", Type: field.TypeString, Size: 32, Default: ""},
		{Name: "first_recharge_offer_id", Type: field.TypeInt64, Nullable: true},
	...
	PaymentOrdersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "paymentorder_activity_type",
				Unique:  false,
				Columns: []*schema.Column{PaymentOrdersColumns[17]},
			},
			{
				Name:    "paymentorder_first_recharge_offer_id",
				Unique:  false,
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "description", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "text"}},
		{Name: "price", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "price_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "original_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "validity_days", Type: field.TypeInt, Default: 30},
