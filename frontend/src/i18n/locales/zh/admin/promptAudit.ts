export default {
  promptAudit: {
    ...
    events: {
      ...
      filterDeleteDialogTitle: '按筛选删除审计事件', filterDeleteDialogDesc: '选择删除的时间范围与风险条件，先获取并核对匹配数量，再确认永久删除。删除不可恢复。',
      ...
      filterDeletePreviewAction: '获取删除预览', filterDeletePreviewing: '正在生成预览…', filterDeleteNeedPreview: '请先获取删除预览并核对匹配数量。',
