...
const (
	...
	// FieldDisplayNotes holds the string denoting the display_notes field in the database.
	FieldDisplayNotes = "display_notes"
...
var (
	...
	DefaultTags string
	// DefaultDisplayNotes holds the default value on creation for the "display_notes" field.
	DefaultDisplayNotes string
...
// ByDisplayNotes orders the results by the display_notes field.
func ByDisplayNotes(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldDisplayNotes, opts...).ToFunc()
}
